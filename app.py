...
def generate_block_every_second():
    scheduled_time_pre = "11:17 AM"
    scheduled_time_close = "11:17 AM"
    while True:
        public_key = load_public_key()
